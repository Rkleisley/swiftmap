...
// src/labels.js
function collectLabels(layers, buffers, groupConfigs) {
  const out = [];
  for (const layer of layers || []) {
...
function renderLabels(L2, group, layers, buffers, groupConfigs) {
