...
def add_polygon(
    ...
    **kwargs
    ...
    # folder -- assembles into a single merged entry placed once, instead of n
    # incremental merges each re-emitting the whole group (quadratic wire and
    # CPU: the 20k-WKT ingest that surfaced it).
    pending = []
